...
* :small-blue-diamond: [PyCharm от JetBrains](http://www.jetbrains.com/pycharm/) - серьезная IDE для больших проектов;
...
* :small-blue-diamond: [Jupyter](http://jupyter.org) – open source, interactive data science and scientific computing across over 40 programming languages. The Jupyter Notebook is a web application that allows you to create and share documents that contain live code, equations, visualizations and explanatory text;
* [nbviewer](http://nbviewer.jupyter.org) – renders notebooks available on other websites;
* :small-blue-diamond: [Sublime Text 3](http://www.sublimetext.com/3) - VIM XXI века*;, отлично подходит для python, если использовать вместе с плагинами:
